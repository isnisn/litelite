...
// Database
  ...
  define('DB_SERVER', '103.57.74.254');
  //define('DB_SERVER', '127.0.0.1');
  define('DB_USERNAME', 'isnisn');
  define('DB_PASSWORD', 'EKDXc5aP');
...
define('DB_TABLE_PRODUCT_TYPES',                         '`'. DB_DATABASE .'`.`'. DB_TABLE_PREFIX . 'products_types`');
...
// Password Encryption Salt
  define('PASSWORD_SALT', 'XaOG7IhN9FHWTCRmoafwiTqyBmIrgx5m6XXpzDK6gq0Fi8oMNekxdt8XmMKRzuS4BwarPlEF0kQtiMc4cCrAfNUvxGz1w4Mhbr1gANbugEFAef3kllPQgqiECZA9npSR');
