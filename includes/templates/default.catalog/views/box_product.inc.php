        ...
        <div>
            ...
            <script type="text/javascript">
                ...
                function addSymbol(data) {
                    ...
                    var text1 = $("input[name='options[Rad1]']").val() + symbol;

                    //Add the symbol...
                    $("input[name='options[Rad1]']").val(text1);
            ...
            <!-- UGLY preload the fonts -->
            <label style="visibility: hidden; position: absolute; font-family: Lalezar; ">ASDF</label>
            <label style="visibility: hidden; position: absolute; font-family: Ultra; ">ASDF</label>
            <label style="visibility: hidden; position: absolute; font-family: Lacquer; ">ASDF</label>
            <label style="visibility: hidden; position: absolute; font-family: Concert One; ">ASDF</label>
            ...
            <div id="buy_now_div" class="buy_now" style="margin: 1em 0;">
                ...
                <?php if($product_type != 3) { ?>
                    <div class="form-group required">
                        ...
                        <span class="padding">Lägg till en symbol</span><br>
                        <div class="margin">
                                <span class="text-symbol" data-symbol="❤" onclick="addSymbol(this)">
